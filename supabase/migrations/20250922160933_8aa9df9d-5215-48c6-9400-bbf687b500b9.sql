...
-- RLS policies for user_alerts (drop existing first to avoid conflicts)
...
-- Performance indexes (without the problematic ones)
...
CREATE INDEX IF NOT EXISTS idx_user_alerts_user_ticker ON public.user_alerts(user_id, ticker);
